...
public class User {
    ...
    @Expose
    private GeneralResponceData region;
    @SerializedName("categories")
    @Expose
    private List<RestaurantMyCategoriesData> categories = null;
    ...
    public GeneralResponceData getRegion() {
        return region;
    }

    public void setRegion(GeneralResponceData region) {
        this.region = region;
    }

    public List<RestaurantMyCategoriesData> getCategories() {
        return categories;
    }

    public void setCategories(List<RestaurantMyCategoriesData> categories) {
