...
import com.example.sofra.adapter.RestaurantCurrentAdapter;
...
public class RestaurantCurrentFragment extends BaseFragment {

    public String type;
    @BindView(R.id.restaurant_curent_fragment_rv_my_order)
    RecyclerView restaurantCurentFragmentRvMyOrder;
    Unbinder unbinder;
    private OnEndLess onEndLess;
    private int maxPage=1;
    private List<RestaurantMyordersData> restaurantCurrentList=new ArrayList<>();
    private RestaurantCurrentAdapter reataurantcurrentAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_restaurant_current, container, false);
    ...
    private void init(int page) {
        ...
        restaurantCurentFragmentRvMyOrder.setLayoutManager(linearLayoutManager);
        ...
        restaurantCurentFragmentRvMyOrder.addOnScrollListener(onEndLess);
        reataurantcurrentAdapter=new RestaurantCurrentAdapter(getActivity(),getActivity(),restaurantCurrentList);
        restaurantCurentFragmentRvMyOrder.setAdapter(reataurantcurrentAdapter);
            ...
            public void onResponse(Call<RestaurantMyOrders> call, Response<RestaurantMyOrders> response) {
                try {
                    if (response.body().getStatus()==1) {
                        ...
                        restaurantCurrentList.addAll(response.body().getData().getData());
                        reataurantcurrentAdapter.notifyDataSetChanged();
                    }
                }catch (Exception e){
